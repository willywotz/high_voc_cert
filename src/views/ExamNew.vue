<template lang="pug">
form.border.rounded.bg-white(@submit.prevent="createExam")
  ...
  .bg-gray-50.py-2.px-4.flex.space-x-2
    ...
    button.py-1.px-2.border.rounded.bg-white(type="submit") สร้าง
</template>
...
export default {
  ...
  methods: {
    ...
    createExam () {
      this.exam.meta = { owner: this.user.uid, createdAt: new Date }
      return addDoc(collection(getFirestore(), 'exams'), this.exam)
